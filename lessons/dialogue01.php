...
$phrases_ukrainian_transliterated_total = ""; 

foreach ($phrases_ukrainian_array as $value) 
{
    $phrases_ukrainian_total = $phrases_ukrainian_total."\"".$value."\",";
    $phrases_ukrainian_transliterated_total = $phrases_ukrainian_transliterated_total."\"".$phrase_transliteration->convert($value)."\",";
} 
...
<title> Lessons - Dialogue <?php $dialogue_number?> </title>
  <link rel="shortcut icon" type="image/x-icon" href="/website_pictures/favicon.ico" />
...
var ukrainianPhraseTransliterated = [<?= $phrases_ukrainian_transliterated_total ?>];
...
var currentTransliterationDisplay = "latin"; /* options are "latin" or "cyrillic"*/
...
for (i=0; i<dialogueLength;i++)
{
	...
	var ukrainianPhraseDisplayed = ukrainianPhraseTransliterated[i];
...
function toggleTransliteration()
{
	...
	if(currentTransliterationDisplay == "latin")
	{
		...
		for (i=0; i<dialogueLength;i++)
		{
			...
			speakerDisplayed = speaker[i];
			ukrainianPhraseDisplayed = ukrainianPhrase[i];
			englishPhraseDisplayed = englishPhrase[i];
			cumulativeTableEntries= cumulativeTableEntries+"  <tr onclick=\"myFunction(" + i + ")\"> 	<td><b>" + speakerDisplayed + "</b></td> <td>" + ukrainianPhraseDisplayed+ "</td> <td>"+englishPhraseDisplayed+"</td>  </tr> ";
